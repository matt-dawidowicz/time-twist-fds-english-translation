...
| Typewriter SFX after leading controls | **VERIFIED root cause / candidate fix** | [Text-control state machine](TEXT_CONTROL_STATE_MACHINE.md#typewriter-sfx-after-a-leading-presentation-control) | Live v19 checkpoint confirmation |
