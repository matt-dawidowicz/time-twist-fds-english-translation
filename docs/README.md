...
- [Part 1 to Part 2 startup handoff](PART2_STARTUP_HANDOFF.md) - verified completed-SAVE eligibility, NOV4 `Start / Load / Part 2` gating, explicit `$C059: E0 C7`, and Kouhen Side-B `TT4` entry.
