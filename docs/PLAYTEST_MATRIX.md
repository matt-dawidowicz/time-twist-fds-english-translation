...
| Z-11 | `TT3A` | POW camp, tunnel, town, Rebecca network, torn note | “Anti-Hitler plot”; Rebecca as organization; separate scientist/POW logic; shared park-departure narration remains gender-neutral on both male and female contact branches; note spatial layout; all command states | Screenshots, especially both park-contact branches and torn note | Pending |
