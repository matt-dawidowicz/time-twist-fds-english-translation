...
System UI records preserve their packed boundaries. Scenario menus are
repacked through their recovered page pointers. Short code patches compare
exact source bytes before writing, and larger tables use SHA-256 guards.
...
from .ui_fixed_tables import (
    T22_FIXED_TEXT_END_OFFSET as T22_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    T22_FIXED_TEXT_RECORDS as T22_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    T22_FIXED_TEXT_SOURCE_SHA256 as T22_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    T22_FIXED_TEXT_START_OFFSET as T22_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    T25_FIXED_TEXT_END_OFFSET as T25_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    T25_FIXED_TEXT_RECORDS as T25_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    T25_FIXED_TEXT_SOURCE_SHA256 as T25_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    T25_FIXED_TEXT_START_OFFSET as T25_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
...
from .ui_fixed_tables import (
    TT1B_FIXED_TEXT_END_OFFSET as TT1B_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT1B_FIXED_TEXT_RECORDS as TT1B_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT1B_FIXED_TEXT_SOURCE_SHA256 as TT1B_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT1B_FIXED_TEXT_START_OFFSET as TT1B_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    TT2_FIXED_TEXT_END_OFFSET as TT2_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT2_FIXED_TEXT_RECORDS as TT2_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT2_FIXED_TEXT_SOURCE_SHA256 as TT2_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT2_FIXED_TEXT_START_OFFSET as TT2_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    TT3A_FIXED_TEXT_END_OFFSET as TT3A_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT3A_FIXED_TEXT_RECORDS as TT3A_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT3A_FIXED_TEXT_SOURCE_SHA256 as TT3A_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT3A_FIXED_TEXT_START_OFFSET as TT3A_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    TT3B_FIXED_TEXT_END_OFFSET as TT3B_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT3B_FIXED_TEXT_RECORDS as TT3B_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT3B_FIXED_TEXT_SOURCE_SHA256 as TT3B_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT3B_FIXED_TEXT_START_OFFSET as TT3B_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    TT4_FIXED_TEXT_END_OFFSET as TT4_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT4_FIXED_TEXT_RECORDS as TT4_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT4_FIXED_TEXT_SOURCE_SHA256 as TT4_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT4_FIXED_TEXT_START_OFFSET as TT4_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    TT5_FIXED_TEXT_END_OFFSET as TT5_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT5_FIXED_TEXT_RECORDS as TT5_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT5_FIXED_TEXT_SOURCE_SHA256 as TT5_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT5_FIXED_TEXT_START_OFFSET as TT5_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    TT6A_FIXED_TEXT_END_OFFSET as TT6A_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT6A_FIXED_TEXT_RECORDS as TT6A_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT6A_FIXED_TEXT_SOURCE_SHA256 as TT6A_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT6A_FIXED_TEXT_START_OFFSET as TT6A_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    TT6B_FIXED_TEXT_END_OFFSET as TT6B_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT6B_FIXED_TEXT_RECORDS as TT6B_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT6B_FIXED_TEXT_SOURCE_SHA256 as TT6B_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT6B_FIXED_TEXT_START_OFFSET as TT6B_FIXED_TEXT_START_OFFSET,
)
from .ui_fixed_tables import (
    TT6C_FIXED_TEXT_END_OFFSET as TT6C_FIXED_TEXT_END_OFFSET,
)
from .ui_fixed_tables import (
    TT6C_FIXED_TEXT_RECORDS as TT6C_FIXED_TEXT_RECORDS,
)
from .ui_fixed_tables import (
    TT6C_FIXED_TEXT_SOURCE_SHA256 as TT6C_FIXED_TEXT_SOURCE_SHA256,
)
from .ui_fixed_tables import (
    TT6C_FIXED_TEXT_START_OFFSET as TT6C_FIXED_TEXT_START_OFFSET,
)

# Preserve source-table metadata on the UI facade for extraction and audits.
# This count describes the native Japanese dictionary, not a release minimum.
...
def _patched_disk_set_error_message(data: bytes) -> bytes:
    """Translate NOV2's byte-aligned compact disk-set status.
...
def _encode_side_number_error(english: str) -> tuple[PackedSymbol, ...]:
    ...
    The alternate eight-byte heading uses ordinary ``Bad side.`` glyphs.
    The observed primary retry instead draws the ten-byte ``Wrong side.``
    record at $26D4 followed by ``Try again.`` at $26DE.
    """
    return encode_english(english)


# Runtime save-state comparison shows the primary same-side retry draws
# $26D4 (Wrong side.) then $26DE (Try again.). The compact alternate heading
# at $26CC uses ordinary Bad side. glyphs. The wrong-disk pair at $26E8/$26F3
# is a separate path. See docs/NOV4_FONT_SOURCE_SAFETY.md for the record map.
