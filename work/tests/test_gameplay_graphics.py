...
class GameplayGraphicsFormatTests(unittest.TestCase):
    ...
    def test_metasprite_definition_handles_visible_and_transparent_cells(self) -> None:
    ...
    def test_static_placement_records_are_count_prefixed_triples(self) -> None:
        ...
        self.assertEqual([len(record.placements) for record in records], [2, 1])
        self.assertEqual(
            (
    ...
    def test_actor_spawn_records_preserve_raw_coordinate_sentinels(self) -> None:
    ...
    def test_hotspot_records_expose_flags_and_special_bottom_markers(self) -> None:
    ...
    def test_background_map_stream_decodes_literals_runs_and_rectangle(self) -> None:
    ...
    def test_background_descriptor_decodes_inline_and_pointer_variants(self) -> None:
    ...
    def test_background_stream_accepts_canonical_empty_noop(self) -> None:
        ...
        self.assertEqual((stream.width, stream.height, stream.tiles), (1, 0, ()))
