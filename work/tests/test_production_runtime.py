...
class ProductionRuntimeTests(unittest.TestCase):
    """Group regression coverage for ProductionRuntime."""

    def _synthetic_nov2(self, *, adaptive: bool = False) -> bytearray:
        """Support the synthetic nov2 operation for this module."""
    ...
    def _adaptive_patch(address: int):
        """Support the adaptive patch operation for this module."""
        matches = [
            patch
    ...
    def test_patches_are_size_neutral_and_source_verified(self) -> None:
        """Verify patches are size neutral and source verified."""
    ...
    def test_source_drift_fails_closed(self) -> None:
        """Verify source drift fails closed."""
    ...
    def test_extended_dictionary_enters_after_native_index_reader(
        ...
        """Verify extended dictionary enters after native index reader."""
    ...
    def test_dollar_sign_redirects_only_extended_code_63(self) -> None:
        """Verify dollar sign redirects only extended code 63."""
        patch = PRODUCTION_RUNTIME_PATCHES[1]
    ...
    def test_menu_renderer_uses_existing_eight_glyph_buffer(self) -> None:
        """Verify menu renderer uses existing eight glyph buffer."""
    ...
    def test_selection_brackets_span_all_eight_visible_glyphs(self) -> None:
        """Verify selection brackets span all eight visible glyphs."""
    ...
    def test_adaptive_dictionary_patch_is_size_neutral_and_idempotent(
        ...
        """Verify adaptive dictionary patch is size neutral and idempotent."""
    ...
    def test_production_scan_limit_reaches_end_of_fds_prg_ram(self) -> None:
        """Verify production scan limit reaches end of fds prg ram."""
    ...
    def test_top_level_decoder_always_clears_nesting_depth(self) -> None:
        """Verify top level decoder always clears nesting depth."""
    ...
    def test_adaptive_dictionary_uses_dead_english_decoder_region(
        ...
        """Verify adaptive dictionary uses dead english decoder region."""
    ...
    def test_nested_dictionary_uses_depth_counter_not_boolean(self) -> None:
        """Verify nested dictionary uses depth counter not boolean."""
    ...
    def test_runtime_patches_never_overlap_live_palette_data(self) -> None:
        """Verify runtime patches never overlap live palette data."""
